package com.dzl.pojo.bo.center;
...
public class CenterUserBO {
    ...
    @Email//直接开启邮箱验证
    @ApiModelProperty(value="邮箱地址", name="email", example="dzl@dzl.com", required = false)
    private String email;

    @Min(value = 0, message = "性别选择不正确")//最小值的设定
    @Max(value = 2, message = "性别选择不正确")//最大值的设定
