...
import com.dzl.mapper.OrderItemsMapper;
import com.dzl.mapper.OrderStatusMapper;
import com.dzl.mapper.OrdersMapper;
import com.dzl.pojo.*;
...
//        newOrder.setRealPayAmount();
        ...
        /**
         * 因为提交的订单可能有多个，商品的规格id需要进行split分割
         */
        ...
        for (String itemSpecId : itemSpecIdArr) {
            ...
            // TODO 整合redis后，商品购买的数量重新从redis的购物车中获取,现在默认购买的件数都是1
            int buyCounts = 1;

            // 2.1 根据规格id，查询规格的具体信息，主要获取价格
            ItemsSpec itemSpec = itemService.queryItemSpecById(itemSpecId);
            totalAmount += itemSpec.getPriceNormal() * buyCounts;//商品的原价 * 购买的件数 = 总价格
